...
public class ProjectsApp {
	...
	private void deleteProject() {
		listProjects();
		Integer projectId = getIntInput("Please select the project you would like to delete");
		
		projectService.deleteProject(projectId);
		
		System.out.println("Project with ID " + projectId + " Successfully deleted.");
	...
	private void updateProjectDetails() {
		...
		Integer difficulty = getIntInput("Enter the diffulty (1-5) [" + curProject.getDifficulty() 
				+ "]");
